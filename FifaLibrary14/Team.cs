...
namespace FifaLibrary
{
    public class Team : IdObject
    {
      ...
      -1
        ...
        public Stadium Stadium
        {
            ...
            set
            {
                ...
                if (this.m_Stadium == null)
                    return;
                this.Stadiumid = this.m_Stadium.Id;
            }
        }
        ...
        public int Stadiumid { get => m_stadiumid; set => m_stadiumid = value; }
        ...
        {
            this.Stadiumid = r.GetAndCheckIntField(FI.teamstadiumlinks_stadiumid);
        }
        ...
        public void LinkStadium(StadiumList stadiumList)
        {
            if (stadiumList == null)
                return;
            this.m_Stadium = (Stadium)stadiumList.SearchId(this.Stadiumid);
        }
        ...
        public void SaveTeamStadiumLinks(Record r)
        {
            ...
            r.IntField[FI.teamstadiumlinks_stadiumid] = this.Stadiumid;
        }
