...
namespace FifaLibrary
{
    public class Kit : IdObject
    {
        ...
        private int m_shortsnumbercolorprimr;
        private int m_shortsnumbercolorprimg;
        private int m_shortsnumbercolorprimb;
        private Color m_ShortsNumberColorPrim;

        private int m_shortsnumbercolorsecr;
        private int m_shortsnumbercolorsecg;
        private int m_shortsnumbercolorsecb;
        private Color m_ShortsNumberColorSec;

        private int m_shortsnumbercolorterr;
        private int m_shortsnumbercolorterg;
        private int m_shortsnumbercolorterb;
        private Color m_ShortsNumberColorTer;
        ...
        private int m_jerseynumbercolorprimr;
        private int m_jerseynumbercolorprimg;
        private int m_jerseynumbercolorprimb;
        private Color m_JerseyNumberColorPrim;

        private int m_jerseynumbercolorsecr;
        private int m_jerseynumbercolorsecg;
        private int m_jerseynumbercolorsecb;
        private Color m_JerseyNumberColorSec;

        private int m_jerseynumbercolorterr;
        private int m_jerseynumbercolorterg;
        private int m_jerseynumbercolorterb;
        private Color m_JerseyNumberColorTer;

        private int m_ShortStyle;
        ...
        public bool hasadvertisingkit
        {
            ...
            set
            {
                ...
                if (this.Id == 604) { Debug.WriteLine("m_hasadvertisingkit >> " + m_hasadvertisingkit); };
            }
        }
        ...
        public Color ShortsNumberColorPrim
        {
            get
            {
                return this.m_ShortsNumberColorPrim;
            }
            set
            {
                this.m_ShortsNumberColorPrim = value;
            }
        }

        public Color ShortsNumberColorSec
        {
            get
            {
                return this.m_ShortsNumberColorSec;
            }
            set
            {
                this.m_ShortsNumberColorSec = value;
            }
        }

        public Color ShortsNumberColorTer
        {
            get
            {
                return this.m_ShortsNumberColorTer;
            }
            set
            {
                this.m_ShortsNumberColorTer = value;
            }
        }
        ...
        public Color JerseyNumberColorPrim
        {
            get
            {
                return this.m_JerseyNumberColorPrim;
            }
            set
            {
                this.m_JerseyNumberColorPrim = value;
            }
        }

        public Color JerseyNumberColorSec
        {
            get
            {
                return this.m_JerseyNumberColorSec;
            }
            set
            {
                this.m_JerseyNumberColorSec = value;
            }
        }

        public Color JerseyNumberColorTer
        {
            get
            {
                return this.m_JerseyNumberColorTer;
            }
            set
            {
                this.m_JerseyNumberColorTer = value;
            }
        }
        ...
        public int ShortStyle { get => this.m_ShortStyle; set => this.m_ShortStyle = value; }
        public bool IsEmbargoed { get => this.m_IsEmbargoed; set => this.m_IsEmbargoed = value; }
        ...
        public void InitNewKit()
        {
            ...
            this.m_jerseynumbercolorprimr = 0;
            this.m_jerseynumbercolorprimg = 0;
            this.m_jerseynumbercolorprimb = 0;
            this.m_jerseynumbercolorsecr = 0;
            this.m_jerseynumbercolorsecg = 0;
            this.m_jerseynumbercolorsecb = 0;
            this.m_jerseynumbercolorterr = 0;
            this.m_jerseynumbercolorterg = 0;
            this.m_jerseynumbercolorterb = 0;

            this.m_shortsnumbercolorprimr = 0;
            this.m_shortsnumbercolorprimg = 0;
            this.m_shortsnumbercolorprimb = 0;
            this.m_shortsnumbercolorsecr = 0;
            this.m_shortsnumbercolorsecg = 0;
            this.m_shortsnumbercolorsecb = 0;
            this.m_shortsnumbercolorterr = 0;
            this.m_shortsnumbercolorterg = 0;
            this.m_shortsnumbercolorterb = 0;
        ...
        public void Load(Record r)
        {
            ...
            this.m_jerseynumbercolorprimr = r.IntField[FI.teamkits_jerseynumbercolorprimr];
            this.m_jerseynumbercolorprimg = r.IntField[FI.teamkits_jerseynumbercolorprimg];
            this.m_jerseynumbercolorprimb = r.IntField[FI.teamkits_jerseynumbercolorprimb];
            this.m_JerseyNumberColorPrim = Color.FromArgb((int)byte.MaxValue, this.m_jerseynumbercolorprimr, this.m_jerseynumbercolorprimg, this.m_jerseynumbercolorprimb);

            this.m_jerseynumbercolorsecr = r.IntField[FI.teamkits_jerseynumbercolorsecr];
            this.m_jerseynumbercolorsecg = r.IntField[FI.teamkits_jerseynumbercolorsecg];
            this.m_jerseynumbercolorsecb = r.IntField[FI.teamkits_jerseynumbercolorsecb];
            this.m_JerseyNumberColorSec = Color.FromArgb((int)byte.MaxValue, this.m_jerseynumbercolorsecr, this.m_jerseynumbercolorsecg, this.m_jerseynumbercolorsecb);

            this.m_jerseynumbercolorterr = r.IntField[FI.teamkits_jerseynumbercolorterr];
            this.m_jerseynumbercolorterg = r.IntField[FI.teamkits_jerseynumbercolorterg];
            this.m_jerseynumbercolorterb = r.IntField[FI.teamkits_jerseynumbercolorterb];
            this.m_JerseyNumberColorTer = Color.FromArgb((int)byte.MaxValue, this.m_jerseynumbercolorterr, this.m_jerseynumbercolorterg, this.m_jerseynumbercolorterb);

            this.m_shortsnumbercolorprimr = r.IntField[FI.teamkits_shortsnumbercolorprimr];
            this.m_shortsnumbercolorprimg = r.IntField[FI.teamkits_shortsnumbercolorprimg];
            this.m_shortsnumbercolorprimb = r.IntField[FI.teamkits_shortsnumbercolorprimb];
            this.m_ShortsNumberColorPrim = Color.FromArgb((int)byte.MaxValue, this.m_shortsnumbercolorprimr, this.m_shortsnumbercolorprimg, this.m_shortsnumbercolorprimb);

            this.m_shortsnumbercolorsecr = r.IntField[FI.teamkits_shortsnumbercolorsecr];
            this.m_shortsnumbercolorsecg = r.IntField[FI.teamkits_shortsnumbercolorsecg];
            this.m_shortsnumbercolorsecb = r.IntField[FI.teamkits_shortsnumbercolorsecb];
            this.m_ShortsNumberColorSec = Color.FromArgb((int)byte.MaxValue, this.m_shortsnumbercolorsecr, this.m_shortsnumbercolorsecg, this.m_shortsnumbercolorsecb);

            this.m_shortsnumbercolorterr = r.IntField[FI.teamkits_shortsnumbercolorterr];
            this.m_shortsnumbercolorterg = r.IntField[FI.teamkits_shortsnumbercolorterg];
            this.m_shortsnumbercolorterb = r.IntField[FI.teamkits_shortsnumbercolorterb];
            this.m_ShortsNumberColorTer = Color.FromArgb((int)byte.MaxValue, this.m_shortsnumbercolorterr, this.m_shortsnumbercolorterg, this.m_shortsnumbercolorterb);

            this.m_ShortStyle = r.IntField[FI.teamkits_shortstyle];
            this.m_IsEmbargoed = r.IntField[FI.teamkits_isembargoed] > 0;
        ...
        public void SaveKit(Record r, int artificialKey)
        {
            ...
            r.IntField[FI.teamkits_jerseynumbercolorprimr] = this.m_jerseynumbercolorprimr = (int)this.m_JerseyNumberColorPrim.R;
            r.IntField[FI.teamkits_jerseynumbercolorprimg] = this.m_jerseynumbercolorprimg = (int)this.m_JerseyNumberColorPrim.G;
            r.IntField[FI.teamkits_jerseynumbercolorprimb] = this.m_jerseynumbercolorprimb = (int)this.m_JerseyNumberColorPrim.B;

            r.IntField[FI.teamkits_jerseynumbercolorsecr] = this.m_jerseynumbercolorsecr = (int)this.m_JerseyNumberColorSec.R;
            r.IntField[FI.teamkits_jerseynumbercolorsecg] = this.m_jerseynumbercolorsecg = (int)this.m_JerseyNumberColorSec.G;
            r.IntField[FI.teamkits_jerseynumbercolorsecb] = this.m_jerseynumbercolorsecb = (int)this.m_JerseyNumberColorSec.B;

            r.IntField[FI.teamkits_jerseynumbercolorterr] = this.m_jerseynumbercolorterr = (int)this.m_JerseyNumberColorTer.R;
            r.IntField[FI.teamkits_jerseynumbercolorterg] = this.m_jerseynumbercolorterg = (int)this.m_JerseyNumberColorTer.G;
            r.IntField[FI.teamkits_jerseynumbercolorterb] = this.m_jerseynumbercolorterb = (int)this.m_JerseyNumberColorTer.B;

            r.IntField[FI.teamkits_shortsnumbercolorprimr] = this.m_shortsnumbercolorprimr = (int)this.m_ShortsNumberColorPrim.R;
            r.IntField[FI.teamkits_shortsnumbercolorprimg] = this.m_shortsnumbercolorprimg = (int)this.m_ShortsNumberColorPrim.G;
            r.IntField[FI.teamkits_shortsnumbercolorprimb] = this.m_shortsnumbercolorprimb = (int)this.m_ShortsNumberColorPrim.B;

            r.IntField[FI.teamkits_shortsnumbercolorsecr] = this.m_shortsnumbercolorsecr = (int)this.m_ShortsNumberColorSec.R;
            r.IntField[FI.teamkits_shortsnumbercolorsecg] = this.m_shortsnumbercolorsecg = (int)this.m_ShortsNumberColorSec.G;
            r.IntField[FI.teamkits_shortsnumbercolorsecb] = this.m_shortsnumbercolorsecb = (int)this.m_ShortsNumberColorSec.B;

            r.IntField[FI.teamkits_shortsnumbercolorterr] = this.m_shortsnumbercolorterr = (int)this.m_ShortsNumberColorTer.R;
            r.IntField[FI.teamkits_shortsnumbercolorterg] = this.m_shortsnumbercolorterg = (int)this.m_ShortsNumberColorTer.G;
            r.IntField[FI.teamkits_shortsnumbercolorterb] = this.m_shortsnumbercolorterb = (int)this.m_ShortsNumberColorTer.B;

            r.IntField[FI.teamkits_shortstyle] = this.m_ShortStyle;
            r.IntField[FI.teamkits_isembargoed] = this.IsEmbargoed ? 1 : 0;
            ...
            r.IntField[FI.teamkits_jerseynamecolorr] = this.m_jerseynamecolorr = (int)this.m_JerseyNameColor.R;
            r.IntField[FI.teamkits_jerseynamecolorg] = this.m_jerseynamecolorg = (int)this.m_JerseyNameColor.G;
            r.IntField[FI.teamkits_jerseynamecolorb] = this.m_jerseynamecolorb = (int)this.m_JerseyNameColor.B;
        ...
        {
            return "Content/Character/Kit/kit_" + teamid.ToString() + "_" + kittype.ToString() + "_" + year.ToString() + ".rx3";
        }
        ...
        {
            return NumberFont.GetNumberFont(this.m_numberfonttype);
        }

        public bool SetJerseyFont(Bitmap[] bitmaps)
        {
            return NumberFont.SetNumberFont(this.m_numberfonttype, bitmaps);
        }
        ...
        {
            return NumberFont.Delete(this.m_numberfonttype);
        }
